================================================================================
    BIBLIOTHÈQUE MFC (MICROSOFT FOUNDATION CLASS) : Vue d'ensemble du projet SaisieJoueur
===============================================================================

L'Assistant Application a créé cette application SaisieJoueur pour vous. Cette application décrit non seulement les bases de l'utilisation de Microsoft Foundation Classes, mais est également un point de départ pour l'écriture de votre application.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application SaisieJoueur.

SaisieJoueur.vcxproj
...
SaisieJoueur.h
    ...
    Il comprend d'autres en-têtes spécifiques au projet (notamment Resource.h) et déclare la classe d'application CSaisieJoueurApp.

SaisieJoueur.cpp
    Il s'agit du fichier source principal de l'application qui contient la classe d'application CSaisieJoueurApp.
...
res\SaisieJoueur.ico
    Il s'agit d'un fichier icône, qui est utilisé comme icône de l'application. Cette icône est incluse par le fichier de ressources principal SaisieJoueur.rc.

res\SaisieJoueur.rc2
...
SaisieJoueurDlg.h, SaisieJoueurDlg.cpp - la boîte de dialogue
    Ces fichiers contiennent votre classe CSaisieJoueurDlg. Cette classe définit le comportement de la boîte de dialogue principale de votre application. Le modèle de la boîte de dialogue se trouve dans SaisieJoueur.rc, qui peut être modifié dans Microsoft Visual C++.
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) SaisieJoueur.pch et un fichier de type précompilé nommé StdAfx.obj.
