...
// SaisieJoueur.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CSaisieJoueurApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CSaisieJoueurApp

CSaisieJoueurApp::CSaisieJoueurApp()
{
...
// Seul et unique objet CSaisieJoueurApp

CSaisieJoueurApp theApp;


// initialisation de CSaisieJoueurApp

BOOL CSaisieJoueurApp::InitInstance()
{
